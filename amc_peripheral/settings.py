...
DISCORD_GATEWAY = os.environ.get("DISCORD_GATEWAY", "wss://gateway.discord.gg/?v=10&encoding=json")
...
GAME_ANNOUNCEMENTS_CHANNEL_ID = int(os.environ.get("GAME_ANNOUNCEMENTS_CHANNEL_ID", "1373149137897263124"))
GAME_SERVER_API_URL = os.environ.get("GAME_SERVER_API_URL", "http://asean-mt-server:8080")
GAME_CHAT_CHANNEL_ID = int(os.environ.get("GAME_CHAT_CHANNEL_ID", "1344219722886938626"))
KNOWLEDGE_FORUM_CHANNEL_ID = int(os.environ.get("KNOWLEDGE_FORUM_CHANNEL_ID", "1348530437768745020"))
NEWS_CHANNEL_ID = int(os.environ.get("NEWS_CHANNEL_ID", "1359088371514867746"))
KNOWLEDGE_LOG_CHANNEL_ID = int(os.environ.get("KNOWLEDGE_LOG_CHANNEL_ID", "1359033463864299594"))
TIMEZONES_CHANNEL_ID = int(os.environ.get("TIMEZONES_CHANNEL_ID", "1355738561865056346"))
...
EDITORIAL_CHANNEL_ID = int(os.environ.get("EDITORIAL_CHANNEL_ID", "1359088371514867746"))
DYNAMIC_NEWS_CHANNEL = int(os.environ.get("DYNAMIC_NEWS_CHANNEL", "1360265161536962580"))
...
DENO_PATH = os.environ.get('DENO_PATH', '/nix/store/vqh16h1p153k533b66i9h1i91b0k816v-deno-1.46.3/bin/deno')
...
LANGUAGE_CHANNELS = get_env_dict("LANGUAGE_CHANNELS", {
...
TRANSLATION_CHANNELS_GAME = get_env_dict("TRANSLATION_CHANNELS_GAME", {
    'english': 1346733584169435136,
    'vietnamese': 1377566939811024896,
    'thai': 1346744784185983008,
    'indonesian': 1346744118130245682,
...
TRANSLATION_CHANNELS_GENERAL = get_env_dict("TRANSLATION_CHANNELS_GENERAL", {
...
LANGUAGE_CHANNELS_GENERAL = get_env_dict("LANGUAGE_CHANNELS_GENERAL", {
    'indonesian': 1358687629503365280,
