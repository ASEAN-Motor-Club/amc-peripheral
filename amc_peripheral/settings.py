...
BOT_MAX_ITERATIONS = int(os.environ.get("BOT_MAX_ITERATIONS", "8"))
BOT_TOOL_STATUS_DELAY_SECONDS = float(os.environ.get("BOT_TOOL_STATUS_DELAY_SECONDS", "5.0"))
...
OFF_TOPIC_CHANNEL_ID = int(os.environ.get("OFF_TOPIC_CHANNEL_ID", "1344350019066794045"))
ASK_BOT_CHANNEL_ID = int(os.environ.get("ASK_BOT_CHANNEL_ID", "1349258054599835740"))
...
SONG_CACHE_PATH = os.environ.get("SONG_CACHE_PATH", "/var/lib/radio/cache")
